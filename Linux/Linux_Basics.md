...
![944a6e02d4ce24ebf02f5b2f3ca1e114_MD5.png](../_resources/Linux_Basics/944a6e02d4ce24ebf02f5b2f3ca1e114_MD5.png)

想要使用bash则需要确保拥有lib下的各个函数库文件

没有依赖库但想要使用bash则会报错如下

![87727257087262a186f7eebb6995744f_MD5.png](../_resources/Linux_Basics/87727257087262a186f7eebb6995744f_MD5.png)
...
![01d58b0c95d05afd4079b03dd508cc4e_MD5.png](../_resources/Linux_Basics/01d58b0c95d05afd4079b03dd508cc4e_MD5.png)

其他的内建变量的使用示例

![77fd632d9cffa87c49ac40ffdbb3825a_MD5.png](../_resources/Linux_Basics/77fd632d9cffa87c49ac40ffdbb3825a_MD5.png)
...
![13d1232062bae2b5368670376d4444ee_MD5.png](../_resources/Linux_Basics/13d1232062bae2b5368670376d4444ee_MD5.png)
...
![f10da89e0b07e0eda8c4d28b216cd874_MD5.png](../_resources/Linux_Basics/f10da89e0b07e0eda8c4d28b216cd874_MD5.png)
...
以docker为例
![55b91cf1ca8373b5e6b33246b327e1f7_MD5.png](../_resources/Linux_Basics/55b91cf1ca8373b5e6b33246b327e1f7_MD5.png)
...
![215f862977ebe34f865d059a684c4d22_MD5.png](../_resources/Linux_Basics/215f862977ebe34f865d059a684c4d22_MD5.png)
...
![91238653c6e8e6603e279c474409f9ab_MD5.png](../_resources/Linux_Basics/91238653c6e8e6603e279c474409f9ab_MD5.png)
...
![21d6eb1b235d93b35c05bff409736782_MD5.png](../_resources/Linux_Basics/21d6eb1b235d93b35c05bff409736782_MD5.png)
...
vim 里 `<` / `>` 用于缩进，缩进量由选项 `shiftwidth`（`sw`）决定：`sw=2` 就是每次缩进 2 个空格。

**用法两种**

- （默认模式）选中行：`Shift+V` 选好行，按 `<` 或 `>`
- （末行模式）给行号：`:10,20<`、`:10,20>`

在vim的末行模式中运行

```
:set sw?        " 查看当前值（:verbose set sw? 会多打印"是哪个文件设的"）
:set sw=2       " 临时设置（当前会话）
```
...
```
:10,20>      " 第 10–20 行右移一个 shiftwidth
:10,20<      " 左移
:10,$<       " 从第 10 行到文件末尾
:%<          " 全文
:.>          " 当前行
...
![5868337d1d74cb62f25fbe671bfdafe5_MD5.png](../_resources/Linux_Basics/5868337d1d74cb62f25fbe671bfdafe5_MD5.png)

只需要在管道符后面加上一个&即可

![5291b5bebf2a0dff8ef97421fd6e7130_MD5.png](../_resources/Linux_Basics/5291b5bebf2a0dff8ef97421fd6e7130_MD5.png)
...
![0a9ff3e23f5be961b7f6d8b4d9a2621e_MD5.png](../_resources/Linux_Basics/0a9ff3e23f5be961b7f6d8b4d9a2621e_MD5.png)

2.直接使用 ！
使用 '!关键字' 可以快速查找并执行 最后一次执行的 以该关键字开头的命令
![4b6f5fca635758aa4ed26d1ddc0094b2_MD5.png](../_resources/Linux_Basics/4b6f5fca635758aa4ed26d1ddc0094b2_MD5.png)
没用的小知识又增加了
...
![109d66a9732bed4014db20be12c68878_MD5.png](../_resources/Linux_Basics/109d66a9732bed4014db20be12c68878_MD5.png)
...
![338cb5e208708cf7466e0de831fba7a5_MD5.png](../_resources/Linux_Basics/338cb5e208708cf7466e0de831fba7a5_MD5.png)
...
![f310b68af89c66d83487d5c9b5a03840_MD5.jpg](../_resources/Linux_Basics/f310b68af89c66d83487d5c9b5a03840_MD5.jpg)
...
![d3c4ccd82df00fadf72ecaeccf298f63_MD5.png](../_resources/Linux_Basics/d3c4ccd82df00fadf72ecaeccf298f63_MD5.png)

![675a64bc9f80cf73c9e88af566904b64_MD5.png](../_resources/Linux_Basics/675a64bc9f80cf73c9e88af566904b64_MD5.png) 因服务器无端重启，导致无法挂载系统
...
![bc77c767c2a42758bf93c8dd27ce79b7_MD5.png](../_resources/Linux_Basics/bc77c767c2a42758bf93c8dd27ce79b7_MD5.png)
...
原图
![62bfcb336d9ed3efbd8ca3daa6e5e033_MD5.png](../_resources/Linux_Basics/62bfcb336d9ed3efbd8ca3daa6e5e033_MD5.png)
