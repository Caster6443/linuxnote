...
![e5bef4dea6e712828b69b69bad2ee1b3_MD5.png](../_resources/Linux_Desktop/e5bef4dea6e712828b69b69bad2ee1b3_MD5.png)  
...
![3714b46c5aee50f0520ab81ef0acdbb1_MD5.png](../_resources/Linux_Desktop/3714b46c5aee50f0520ab81ef0acdbb1_MD5.png)  
...
while true; do
  RANDOM_IMG=$(find ~/Pictures/Wallpapers -type f \( -iname \*.jpg -o -iname \*.png -o -iname \*.gif -o -iname \*.webp \) | shuf -n 1)
...
![](../_resources/Linux_Desktop/47527c260fbfbee403705d669ec83b3e_MD5.jpg)
...
openlist将各种网盘存储统一起来便于管理，这样就不用下载各种网盘客户端了，更何况有的网盘压根就没有linux客户端
...
添加成功后就可以通过网页访问各种网盘的资源列表了，不过这里希望它挂载在我的文件管理器上，所以需要继续配置，下面有两种方案可供选择

## Rclone方案

如果觉得命令行配置太抽象，我记得这个工具有flatpak版图形化配置的，这里仅介绍命令行部署过程
...
这个会涉及到FUSE锁死问题，具体表现就是卡死，文件管理器卡死就算了，它还会带着所有终端一起卡，不过这个和我用的百度网盘限流问题有一些关联，没🐴的百度网盘
...
编辑hyprland配置文件，写入如下快捷键绑定(参考出处是官方文档)
...
打开软件Crow Translate  
点右下角三个横线进入这个界面的这个设置  
![0a0a553e147730d9c419a9bde4feaf87_MD5.png](../_resources/Linux_Desktop/0a0a553e147730d9c419a9bde4feaf87_MD5.png)  
把安装的 OCR 语言包都勾选上  

再到这个选项  
![4a6cfd13a058ea72523797bb98fca63f_MD5.png](../_resources/Linux_Desktop/4a6cfd13a058ea72523797bb98fca63f_MD5.png)  
...
![2f595e1d4a2c51550e22cf213bcb7f00_MD5.png](../_resources/Linux_Desktop/2f595e1d4a2c51550e22cf213bcb7f00_MD5.png)  
...
![a7e2f3ce98025b7463ef958137883955_MD5.png](../_resources/Linux_Desktop/a7e2f3ce98025b7463ef958137883955_MD5.png)  
...
![b3ade282afba90d071c64eae7e0094b2_MD5.png](../_resources/Linux_Desktop/b3ade282afba90d071c64eae7e0094b2_MD5.png)  
...
![3336fc2cde1b2d0b9e23a4ecf5bb1b30_MD5.png](../_resources/Linux_Desktop/3336fc2cde1b2d0b9e23a4ecf5bb1b30_MD5.png)  
...
![e958a4e711bd12a528ab5a5ce2093e19_MD5.png](../_resources/Linux_Desktop/e958a4e711bd12a528ab5a5ce2093e19_MD5.png)  
...
我的设备信息  
![05fb4d754cd84c33fdca4e18c3f79d6d_MD5.jpg](../_resources/Linux_Desktop/05fb4d754cd84c33fdca4e18c3f79d6d_MD5.jpg)  
...
![3cffcf9af553ff1be660276dffd6b4de_MD5.jpg](../_resources/Linux_Desktop/3cffcf9af553ff1be660276dffd6b4de_MD5.jpg)  
...
![0213e11d14c3c5017942db2882b877b0_MD5.jpg](../_resources/Linux_Desktop/0213e11d14c3c5017942db2882b877b0_MD5.jpg)  
...
![41c68fa8ab9ceef4adba6aa125d824f5_MD5.jpg](../_resources/Linux_Desktop/41c68fa8ab9ceef4adba6aa125d824f5_MD5.jpg)  
...
![62676cbb4a42c76b7f395b46c97e51ad_MD5.jpg](../_resources/Linux_Desktop/62676cbb4a42c76b7f395b46c97e51ad_MD5.jpg)  

开机后装上n卡驱动，在设备管理器上可以看到n卡成功安装使用了  
![099e5e3183ec6f56a47ff67d14f8f207_MD5.jpg](../_resources/Linux_Desktop/099e5e3183ec6f56a47ff67d14f8f207_MD5.jpg)  

#### moonlight远程连接方案(不建议使用)

删除虚拟机的硬件的显示协议和QXL的显卡，然后添加鼠标和键盘，键盘随便拿了个外接键盘，鼠标就用我现在的雷柏，直通开机后，我直通进去的鼠标键盘就会被虚拟机独占了，所以我的笔记本可以使用自带键盘和触摸板  
![a5b461818005e59b7a9bd18f0bbef7cc_MD5.jpg](../_resources/Linux_Desktop/a5b461818005e59b7a9bd18f0bbef7cc_MD5.jpg)  
...
配置结束大概是这样  
![52a72e57902a24011dcd312b0bdf4e83_MD5.jpg](../_resources/Linux_Desktop/52a72e57902a24011dcd312b0bdf4e83_MD5.jpg)  
...
添加文件系统类型的硬件  
![3c515fd8863a183782d1c8f03217cd43_MD5.jpg](../_resources/Linux_Desktop/3c515fd8863a183782d1c8f03217cd43_MD5.jpg)  
...
![b79450be15fd37f4bd46d8e4e9e00025_MD5.jpg](../_resources/Linux_Desktop/b79450be15fd37f4bd46d8e4e9e00025_MD5.jpg)  
...
![3d4acfcc17d6def5939c834ae1bd67cb_MD5.png](../_resources/Linux_Desktop/3d4acfcc17d6def5939c834ae1bd67cb_MD5.png)  
...
如何验证？  
`pw-top`命令查看  
![fac656bba474cf4bdd53348fe1d1c242_MD5.jpg](../_resources/Linux_Desktop/fac656bba474cf4bdd53348fe1d1c242_MD5.jpg)  
...
具体表现是输入法候选词的框没有跟随输入时的光标下面出现，可以通过安装拓展修复(在此之前需要安装拓展管理器)，但是这个插件无法解决副屏的输入法错位问题
