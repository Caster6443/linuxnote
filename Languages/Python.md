...
当前,整个鲨鱼舰队被全部击落后,玩家将提高一个等级,但游戏的难度不变。下面来增加一点儿趣味性:每当玩家将屏幕上的太空鲨鱼全部击落后,都加快游戏的节奏, 让游戏玩起来更难。
...
鉴于玩家每提高一个等级,游戏都会变得更难,因此在处于较高的等级时,太空鲨的分数应该更高。为了实现这个功能,需要编写在游戏节奏加快时提高分数的代码:
...
- 这里导入了 Sprite,让 Ship 继承 Sprite,并在 \_\_init\_\_() 的开头调用 super() 以完成精灵的初始化工作。
